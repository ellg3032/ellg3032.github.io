...
small_text.addEventListener("click", () => {
  change_text_size(0.75);
});
med_text.addEventListener("click", () => {
  change_text_size(1);
});
large_text.addEventListener("click", () => {
  change_text_size(1.5);
});
clear_pref.addEventListener("click", () => {
